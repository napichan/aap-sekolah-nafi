<?php
    ...
    if(isset($_POST['update'])){
        extract($_POST);
        $update = mysqli_query($conn,"update tblsiswa set nis='$nis', nisn='$nisn',nama_siswa='$nama_siswa', alamat='$alamat', hp='$hp', agama='$agama', jk='$jk' where id=$id");
        var_dump($update);
        if($update){
            ?>
            <script>
    ...
    if($id == ""){
        echo "<script>alert('data tidak ditemukan');location.href='tampil.php';</script>";
    }else{
