<?php
     ...
     if($kelas != "" && $bulan != "" && $kelas != ""){
        ...
        $sql = mysqli_query($conn, "select a.nama_siswa, b.nama_kelas from tblsiswa a, tbkelas b, tbsetkelas c where a.id=c.idsiswa AND b.idkelas=c.idkelas AND b.idkelas=$kelas order by a.nama_siswa ASC");
